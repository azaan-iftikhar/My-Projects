    ...
    <section className="w-full bg-surface-bright py-section-padding-sm md:py-section-padding-lg border-t border-brand-border">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-gutter">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter items-stretch">
            ...
            <div className="lg:col-span-4 relative w-full flex flex-col">
            ...
            <div className="lg:col-span-8 overflow-hidden">
                <div className={`minimal-card h-full flex flex-col p-8 lg:p-12 fade-transition ${animating ? 'fade-out' : 'fade-in'}`}>
