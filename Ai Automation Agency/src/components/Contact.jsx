        ...
        <section id="contact" className="w-full bg-surface-bright py-section-padding-sm md:py-section-padding-lg border-t border-brand-border">
            <div className="max-w-container-max mx-auto px-margin-mobile md:px-gutter">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    ...
                    <div className="minimal-card p-8 flex flex-col items-center text-center gap-6 hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-shadow duration-300">
                        ...
                        <a href="https://calendly.com/ecomauto_ai/30min" className="btn-primary w-full shadow-[0_4px_15px_rgba(229,62,62,0.2)] hover:shadow-[0_8px_25px_rgba(229,62,62,0.3)]">
                            Schedule a meeting
                        </a>
                    </div>
                    ...
                    <div className="minimal-card p-8 flex flex-col items-center text-center gap-6 hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-shadow duration-300">
                        ...
                        <a href="mailto:hello@ecomauto.agency" className="btn-secondary w-full border-2 border-brand-dark hover:bg-brand-dark hover:text-white transition-colors duration-300">
